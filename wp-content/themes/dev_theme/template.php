...
<head>
  ...
  <style>
    aside { width: <?php if(is_home()): echo '300px;'; else: echo '200px;'; endif; ?> }
    body { background: url('<?php bloginfo('template_directory') ?>/images/<?php if(is_home()): echo "home-bg.jpg') center 420px"; else: echo "inner-bg.jpg') center top repeat-x"; endif; ?>; }
  </style>
  <!--[if IE 7]>
  ...
  <div id="container">
    <header>
      ...
      <div class="right" style="margin-top: 20px;">
        <span class="cartobook right font18">Call now for more info</span><br />
        <span class="red font30 cartobold right">615-420-6342</span>
      </div>
      <nav>
        <ul class="inline">
